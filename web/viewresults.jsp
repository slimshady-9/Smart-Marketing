  ...
  <a href="Login.jsp">Logout</a></div>
        ...
        <div id="Layer4">
          <form name="form1" method="get" action="#">
              <p><b>RECOMMENDED PRODUCT LINKS</b></p>
...
try
{
           ...
           String query="Select *from results";
            ...
            String linkarray[]=st12.split("...#");
                       
            for (int i = 0; i <linkarray.length; i++) 
            {
              String s1=linkarray[i];
              s1=s1.replace("#", "");
              s1=s1.trim(); 
              links.add(s1);
            }
       ...
       // links.add("https://pypi.org/project/matplotlib/");
        for (int i = 0; i < 10; i++) {
     ...
     {
        String st=links.get(i).toString();
 %>
  <p><a href=<%=links.get(i).toString()%>><%=st%></a></p>
